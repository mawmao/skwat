...
interface Monitorable {
    val monitoringVisit: MonitoringVisit?
}
...
data class FieldDataForm(
    ...
    @SerialName("monitoring_visit") override val monitoringVisit: MonitoringVisit? = null,
...
data class CulturalManagementForm(
    ...
    @SerialName("monitoring_visit") override val monitoringVisit: MonitoringVisit?,
) : FormData(), Monitorable
...
data class FieldActivityDetails(
    ...
    @SerialName("season_year") val seasonYear: String,
    @SerialName("semester") val semester: String,
    @SerialName("field_id") val fieldId: Int,
    @SerialName("season_id") val seasonId: Int,
    @SerialName("activity_type") val activityType: String,
    @SerialName("collected_by") val collectedBy: User?,
    @SerialName("verified_by") val verifiedBy: User?,
    ...
    @SerialName("synced_at") val syncedAt: Instant?,
    ...
    @SerialName("original_activity_id") val originalActivityId: Int?,
